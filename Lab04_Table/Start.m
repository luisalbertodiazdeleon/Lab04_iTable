...
//-------------------------------------------------------------------------------
- (void)initController {
    maIntroTitles   = [[NSMutableArray alloc] initWithObjects: @"Estos son", @"Los personajes de", @"Los Simpson", nil];
    maIntroImgs = [[NSMutableArray alloc] initWithObjects: @"lisa_test.gif", @"maggie_test.gif", @"bart_test.png", nil];
